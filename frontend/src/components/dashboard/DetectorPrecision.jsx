...
const COLORS = ["#FF2A6D", "#FFB703", "#9D4EDD", "#38BDF8", "#10B981", "#94A3B8", "#F97316"];
...
export const DetectorPrecision = () => {
  ...
  return (
    <div className="panel p-4" data-testid="detector-precision-card">
      <div className="mb-2 flex items-center gap-2"><Target size={14} color="#9D4EDD" /><h3 className="font-display text-sm font-semibold">Detector precision</h3><span className="ml-auto font-mono text-[10px] text-slate-500">{o.reviewed} reviewed · {o.pending_review} awaiting</span></div>
      <div className="flex items-center gap-4">
        <div>
          <div className="font-display text-4xl font-extrabold tracking-tight" data-testid="detector-precision-value" style={{ color: o.precision == null ? "#64748B" : o.precision >= 0.7 ? "#10B981" : o.precision >= 0.4 ? "#FFB703" : "#FF2A6D" }}>{o.precision == null ? "—" : pct(o.precision)}</div>
